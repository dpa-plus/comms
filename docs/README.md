...
The per-repo Codex integration template is [`../examples/AGENTS.md.template`](../examples/AGENTS.md.template).
The Claude Code hooks snippet is [`../examples/settings.json.snippet`](../examples/settings.json.snippet).
