...
func TestIsEphemeralPath(t *testing.T) {
	cases := []struct {
		...
		{"/Users/eli/Library/Application Support/comms/abc123", false},
		{"/home/eli/.local/share/comms/abc123", false},
...
func TestEphemeralStoreUsesLogDir(t *testing.T) {
	...
	if (Paths{LogDir: "/Users/eli/Library/Application Support/comms/x"}).EphemeralStore() {
